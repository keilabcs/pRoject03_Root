...
################################################# Inicio de Predicion GERAL NCM 
# Um algoritmo de predição de palavras.
#Nossos propósitos de tentar construir um preditor de próxima palavra com toda base de ncm.

#Defina as opções de knitr 
options(width=120)
...
#Definir NCM
B <- X1$DESCR_PROD # NCM GERAL DE ELETRO
B
...
all.sam[4]
wordList(all.sam[4])
#[1] "##s##"  "chip"   "claro"  "oda"    "128kb"  "aac006" "triple" "pre"    "pag"    "##es##"
...
#Para isso, vamos combinar todas as linhas de todas as amostras de dados em uma lista de ocorrências de token 
#(observando que ainda estão em ordem, para que possamos usar isso mais tarde para nossa consideração de sequências de 
#duas palavras e sequências de três palavras) .
...
#Para está aplicação, é melhor considerar a redução do número de tokens na coleção, 
...
w <- predict("churrasqueira",wordCountsN3,10)
w

#     wordsNgram       Freq
#16900  mor araguaia 0.21666667
#16882  ##es## ##s## 0.19166667
#16884         a gas 0.09166667
#16891   em aluminio 0.09166667
#16887        de aco 0.08333333
#16894   gas fischer 0.07500000
#16901 mor guarapari 0.04166667
#16899    maritima a 0.03333333
